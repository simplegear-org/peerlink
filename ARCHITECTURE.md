...
- Personal media/blob strategy:
  ...
  - relay media upload/download mechanics and incoming retry state/timers are isolated in `lib/ui/state/relay_media_transfer_service.dart`; `ChatController` owns message state and UI orchestration.
