...
class SettingsInviteCodec {
  ...
  static String exportInvitePayload({
    ...
    Map<String, dynamic>? identityBundleV3,
  }) {
    return jsonEncode(<String, dynamic>{
      ...
      'peer': <String, dynamic>{
        ...
        ...?identityBundleV3 == null
            ? null
            : <String, dynamic>{'identityBundleV3': identityBundleV3},
      },
  ...
  static PeerLinkInviteImport parseInvitePayload(String raw) {
    ...
    final identityBundleV3 = peerMap['identityBundleV3'] is Map
        ? Map<String, dynamic>.from(peerMap['identityBundleV3'] as Map)
        : null;
    ...
    return PeerLinkInviteImport(
      ...
      identityBundleV3: identityBundleV3,
    );
  }
}
