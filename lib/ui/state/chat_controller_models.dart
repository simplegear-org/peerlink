...
class IncomingGroupKeyRequestPayload {
  final String groupId;
  final String ownerPeerId;
  ...
  const IncomingGroupKeyRequestPayload({
    required this.groupId,
    required this.ownerPeerId,
...
class IncomingMessageReceiptPayload {
  final String chatId;
  final bool isGroup;
  ...
  const IncomingMessageReceiptPayload({
...
final class IncomingGroupKeyRequestDispatch extends IncomingChatDispatch {
  final IncomingGroupKeyRequestPayload payload;

  const IncomingGroupKeyRequestDispatch(this.payload);
}
...
final class IncomingMessageReceiptDispatch extends IncomingChatDispatch {
  final IncomingMessageReceiptPayload payload;

  const IncomingMessageReceiptDispatch(this.payload);
}
