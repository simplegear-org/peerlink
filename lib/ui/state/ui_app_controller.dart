...
class UiAppController {
  ...
  final AndroidCallLogService androidCallLogService;

  UiAppController({
    required this.contactsRepository,
    required this.callLogRepository,
    required this.contactsController,
    this.androidCallLogService = const AndroidCallLogService(),
  });
  ...
  String contactNameFor(String? peerId) {
    ...
    for (final contact in contactsController.contacts) {
    ...
    return contactsRepository.displayName(normalizedPeerId);
  }
  ...
  Future<void> recordCall(CallState state) async {
    ...
    await androidCallLogService.record(entry);
  }
