  ...
  static Message copy(
    ...
    return Message(
      ...
      sendProgress: identical(sendProgress, _sentinel)
          ? source.sendProgress
          : _asNullableDouble(sendProgress),
      transferStatus: identical(transferStatus, _sentinel)
          ? source.transferStatus
          : transferStatus as String?,
      status: status ?? source.status,
      receiptStatus: receiptStatus ?? source.receiptStatus,
      deliveredAtByPeer: deliveredAtByPeer ?? source.deliveredAtByPeer,
      readAtByPeer: readAtByPeer ?? source.readAtByPeer,
