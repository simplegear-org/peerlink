...
class ChatInboundSubscriptionCoordinator {
  ...
  final Future<void> Function(IncomingMessageReceiptPayload payload)
  ...
  ChatInboundSubscriptionCoordinator({
    ...
    required this.handleIncomingGroupKeyRequest,
    ...
    required this.handleIncomingMessageReceipt,
  ...
  void start() {
    _registration ??= facade.addMessageEventHandler((event) async {
      ...
      await inboundService.handleIncomingMessage(
        ...
        handleIncomingGroupKeyRequest: (msg, payload) =>
            handleIncomingGroupKeyRequest(msg, payload: payload),
