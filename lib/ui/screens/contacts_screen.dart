...
class _ContactPresenceStatus extends StatefulWidget {
  ...
  @override
  State<_ContactPresenceStatus> createState() => _ContactPresenceStatusState();
}

class _ContactPresenceStatusState extends State<_ContactPresenceStatus> {
  ...
  Widget build(BuildContext context) {
    final text = ChatScreenHelpers.lastSeenLabel(
      isPeerOnline: widget.presenceService.isPeerOnline(widget.peerId),
      lastSeenAt: widget.presenceService.peerLastSeenAt(widget.peerId),
      fallbackLastSeenAt: widget.fallbackLastSeenAt,
...
class _ContactsScreenState extends State<ContactsScreen> {
  ...
  void initState() {
    ...
    controller.addListener(_handleContactsChanged);
                ...
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  return Padding(
                    ...
                    child: ContactTile(
                      ...
                      status: _ContactPresenceStatus(
                        peerId: contact.peerId,
                        presenceService: widget.presenceService,
                        fallbackLastSeenAt: _contactFallbackLastSeenAt(
                          contact.peerId,
                        ),
                      ),
                      trailing: isBlocked
  ...
  @override
  void dispose() {
    controller.removeListener(_handleContactsChanged);
    _avatarSubscription?.cancel();
    _discoverySubscription?.cancel();
    super.dispose();
  }

  DateTime? _contactFallbackLastSeenAt(String peerId) {
    ...
    if (chat != null) {
      ...
      if (chat.previewMessage?.incoming == true) {
        return chat.previewMessage!.timestamp;
      }
    }
    return null;
  }
