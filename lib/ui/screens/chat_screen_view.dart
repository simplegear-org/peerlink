        ...
        children: [
                      ...
                      children: [
                        Text(
                          replySenderLabel?.trim().isNotEmpty == true
                              ? strings.replyTo(replySenderLabel!)
          ...
          Row(
            children: [
              ...
              Expanded(child: _buildComposerInput(context, canSend)),
            ...
            Expanded(
              child: Text(
                context.strings.recording(
                  ChatScreenHelpers.formatComposerDuration(recordingDuration),
                ),
