...
import '../../core/runtime/server_runtime_utils.dart';
...
class _TurnServersScreenState extends State<TurnServersScreen> {
      ...
      builder: (dialogContext) {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () async {
                final normalizedHost = ServerRuntimeUtils.normalizeHostOnly(
                  hostCtrl.text,
                  defaultScheme: 'turn',
                );
                ...
                final isIpHost = ServerRuntimeUtils.isIpAddressHost(
                  normalizedHost,
                );
                final urls = <String>[
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(strings.turnServersTitle),
        actions: [
          IconButton(
