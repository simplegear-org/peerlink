...
class AppStrings implements SettingsServerStatusStrings {
  ...
  String get profileAbout => _text('profileAbout');
  String get profileAboutHint => _text('profileAboutHint');
  String get peerProfile => _text('peerProfile');
  String get groupInfo => _text('groupInfo');
  String get groupOwner => _text('groupOwner');
  String get groupAdmin => _text('groupAdmin');
  String get aboutUser => _text('aboutUser');
  String get messageNotifications => _text('messageNotifications');
  String get callNotifications => _text('callNotifications');
  String get notificationsOn => _text('notificationsOn');
  String get notificationsMuted => _text('notificationsMuted');
  String get inContacts => _text('inContacts');
  ...
  String get accountDevicesTitle => _text('accountDevicesTitle');
  String get accountDevicesDescription => _text('accountDevicesDescription');
  String get accountDeviceManagementPrimaryOnlyTitle =>
      _text('accountDeviceManagementPrimaryOnlyTitle');
  String get accountDeviceManagementPrimaryOnlyDescription =>
      _text('accountDeviceManagementPrimaryOnlyDescription');
  String get accountDeviceManagementPrimaryOnlyNotice =>
      _text('accountDeviceManagementPrimaryOnlyNotice');
  String get accountPairingScanBlockedManagedDevices =>
      _text('accountPairingScanBlockedManagedDevices');
  String get accountPairingTransportUnavailable =>
      _text('accountPairingTransportUnavailable');
  String get accountId => _text('accountId');
  String get currentDevice => _text('currentDevice');
  String get devices => _text('devices');
  String get showPairingQr => _text('showPairingQr');
  String get scanPairingQr => _text('scanPairingQr');
  String get accountPairingTitle => _text('accountPairingTitle');
  String get accountPairingDescription => _text('accountPairingDescription');
  String get accountPairingApproveTitle => _text('accountPairingApproveTitle');
  String get accountPairingApproveDescription =>
      _text('accountPairingApproveDescription');
  String get accountPairingApproveAction =>
      _text('accountPairingApproveAction');
  String get accountPairingRequestDescription =>
      _text('accountPairingRequestDescription');
  String get accountPairingRequestAction =>
      _text('accountPairingRequestAction');
  String get accountPairingCurrentAccountLabel =>
      _text('accountPairingCurrentAccountLabel');
  String get accountPairingTargetAccountLabel =>
      _text('accountPairingTargetAccountLabel');
  String get accountPairingLinkLabel => _text('accountPairingLinkLabel');
  String get accountPairingLinkCopied => _text('accountPairingLinkCopied');
  String get accountPairingTapToCopy => _text('accountPairingTapToCopy');
  String accountPairingSwitchAccountWarning(
    String currentAccountId,
    String targetAccountId,
  ) => _format('accountPairingSwitchAccountWarning', {
    'currentAccountId': currentAccountId,
    'targetAccountId': targetAccountId,
  });
  String get accountPairingQrSwitchWarning =>
      _text('accountPairingQrSwitchWarning');
  String get accountPairingRequestSent => _text('accountPairingRequestSent');
  String get accountPairingWaitingApproval =>
      _text('accountPairingWaitingApproval');
  String get accountPairingRequestsTitle =>
      _text('accountPairingRequestsTitle');
  String get accountPairingRequestsDescription =>
      _text('accountPairingRequestsDescription');
  String accountPairingRequestFrom(String deviceId) =>
      _format('accountPairingRequestFrom', {'deviceId': deviceId});
  String get accountPairingApprovedNotice =>
      _text('accountPairingApprovedNotice');
  String get accountPairingRejectedNotice =>
      _text('accountPairingRejectedNotice');
  String get accountPairingRequestExpiredNotice =>
      _text('accountPairingRequestExpiredNotice');
  String get accountPairingWarning => _text('accountPairingWarning');
  String accountPairingAvailableFor(String time) =>
      _format('accountPairingAvailableFor', {'time': time});
  String accountPairingExpiresAt(String time) =>
      _format('accountPairingExpiresAt', {'time': time});
  String get accountDeviceHistoryTitle => _text('accountDeviceHistoryTitle');
  String get accountDeviceHistoryEmpty => _text('accountDeviceHistoryEmpty');
  String get accountDeviceHistoryButton => _text('accountDeviceHistoryButton');
  String accountDeviceEventAdded(String deviceId) =>
      _format('accountDeviceEventAdded', {'deviceId': deviceId});
  String accountDeviceEventRemoved(String deviceId) =>
      _format('accountDeviceEventRemoved', {'deviceId': deviceId});
  String accountDeviceEventPairRequestSent(String deviceId) =>
      _format('accountDeviceEventPairRequestSent', {'deviceId': deviceId});
  String accountDeviceEventPairApproved(String deviceId) =>
      _format('accountDeviceEventPairApproved', {'deviceId': deviceId});
  String accountDeviceEventPairRejected(String deviceId) =>
      _format('accountDeviceEventPairRejected', {'deviceId': deviceId});
  String accountPairingShareText(String accountId, String pairingLink) =>
      _format('accountPairingShareText', {
        'accountId': accountId,
        'pairingLink': pairingLink,
      });
  String accountPairingImported(int count) =>
      _format('accountPairingImported', {'count': count});
  String get accountDevicesManageTitle => _text('accountDevicesManageTitle');
  String get accountDevicesManageDescription =>
      _text('accountDevicesManageDescription');
  String get accountDevicesEmpty => _text('accountDevicesEmpty');
  String get currentDeviceBadge => _text('currentDeviceBadge');
  String get revokeDevice => _text('revokeDevice');
  String revokeDeviceDescription(String deviceId) =>
      _format('revokeDeviceDescription', {'deviceId': deviceId});
  String get revokeDeviceTitle => _text('revokeDeviceTitle');
  String get revokeAllOtherDevices => _text('revokeAllOtherDevices');
  String get revokeAllOtherDevicesTitle => _text('revokeAllOtherDevicesTitle');
  String get revokeAllOtherDevicesDescription =>
      _text('revokeAllOtherDevicesDescription');
  String get deviceRevokedNotice => _text('deviceRevokedNotice');
  String get otherDevicesRevokedNotice => _text('otherDevicesRevokedNotice');
  ...
  String inviteShareText(
    String peerId,
    String inviteDirectLink,
    String inviteFallbackLink,
  ) => _format('inviteShareText', {
    'peerId': peerId,
    'inviteDirectLink': inviteDirectLink,
    'inviteFallbackLink': inviteFallbackLink,
  });
  ...
  String get logLevel => _text('logLevel');
  String get logLevelErrorsOnly => _text('logLevelErrorsOnly');
  String get logLevelVerbose => _text('logLevelVerbose');
  String get showLog => _text('showLog');
  String get shareLog => _text('shareLog');
  String get clearLog => _text('clearLog');
  String get dataResetTitle => _text('dataResetTitle');
  String get dataResetDescription => _text('dataResetDescription');
  String get resetLocalAccount => _text('resetLocalAccount');
  String get resetLocalAccountTitle => _text('resetLocalAccountTitle');
  String get resetLocalAccountDescription =>
      _text('resetLocalAccountDescription');
  String get resetDeviceCompletely => _text('resetDeviceCompletely');
  String get resetDeviceCompletelyTitle => _text('resetDeviceCompletelyTitle');
  String get resetDeviceCompletelyDescription =>
      _text('resetDeviceCompletelyDescription');
  String get resetRestartRequiredNotice => _text('resetRestartRequiredNotice');
  ...
  String serverConfigShareText(
    String configDirectLink,
    String configFallbackLink,
  ) => _format('serverConfigShareText', {
    'configDirectLink': configDirectLink,
    'configFallbackLink': configFallbackLink,
  });
  ...
  String get pushServerSharingTitle => _text('pushServerSharingTitle');
  String get pushServerSharingDescription =>
      _text('pushServerSharingDescription');
  String get shareServersInPush => _text('shareServersInPush');
  String get receiveServersFromPush => _text('receiveServersFromPush');
  ...
  String get pushSummary => _text('pushSummary');
  ...
  String get pushServersTitle => _text('pushServersTitle');
  String get pushServersDescription => _text('pushServersDescription');
  String get pushConfigured => _text('pushConfigured');
  ...
  String get videoCodecUnsupported => _text('videoCodecUnsupported');
  String get openInAnotherApp => _text('openInAnotherApp');
  ...
  String get deployPreviewTitle => _text('deployPreviewTitle');
  String get preparingInstall => _text('preparingInstall');
  String get servicesAddedToConfig => _text('servicesAddedToConfig');
  String deployStage(int stage, int total, String message) => _format(
    'deployStage',
    {'stage': stage, 'total': total, 'message': message},
  );
  String deployStageMessage(SelfHostedDeployStageEvent event) {
    final key = switch (event.kind) {
      SelfHostedDeployStageKind.connectToServer => 'deployStageConnect',
      SelfHostedDeployStageKind.updateOperatingSystem => 'deployStageUpdateOs',
      SelfHostedDeployStageKind.cloneRepository => 'deployStageCloneRepo',
      SelfHostedDeployStageKind.runDeploy => 'deployStageRunDeploy',
      SelfHostedDeployStageKind.installDocker => 'deployStageInstallDocker',
      SelfHostedDeployStageKind.installDockerCompose =>
        'deployStageInstallDockerCompose',
      SelfHostedDeployStageKind.installOpenSsl => 'deployStageInstallOpenSsl',
      SelfHostedDeployStageKind.generateCertificate =>
        'deployStageGenerateCertificate',
      SelfHostedDeployStageKind.generateHaproxy => 'deployStageGenerateHaproxy',
      SelfHostedDeployStageKind.generateTurn => 'deployStageGenerateTurn',
      SelfHostedDeployStageKind.deploymentComplete => 'deployStageComplete',
      SelfHostedDeployStageKind.bootstrapEndpoint =>
        'deployStageBootstrapEndpoint',
      SelfHostedDeployStageKind.relayEndpoint => 'deployStageRelayEndpoint',
      SelfHostedDeployStageKind.testBootstrapOk => 'deployStageTestBootstrapOk',
      SelfHostedDeployStageKind.testBootstrapFail =>
        'deployStageTestBootstrapFail',
      SelfHostedDeployStageKind.testRelayOk => 'deployStageTestRelayOk',
      SelfHostedDeployStageKind.testRelayFail => 'deployStageTestRelayFail',
      SelfHostedDeployStageKind.testTurnOk => 'deployStageTestTurnOk',
      SelfHostedDeployStageKind.testTurnFail => 'deployStageTestTurnFail',
      SelfHostedDeployStageKind.unknown => '',
    };
    if (key.isEmpty) {
      return event.rawMessage.trim();
    }
    return _format(key, {'endpoint': event.details});
  }

  String deployErrorLog(Object error) =>
      _format('deployErrorLog', {'error': error});
  String deployInputError(SelfHostedDeployInputError error) {
    final key = switch (error) {
      SelfHostedDeployInputError.invalidHost => 'deployInvalidHost',
      SelfHostedDeployInputError.missingUsername => 'deployMissingUsername',
      SelfHostedDeployInputError.missingPassword => 'deployMissingPassword',
    };
    return _text(key);
  }

  String deployServiceError(SelfHostedDeployError error) {
    final key = switch (error) {
      SelfHostedDeployError.commandFailedBeforeServiceChecks =>
        'deployCommandFailedBeforeChecks',
      SelfHostedDeployError.completionMarkerMissing =>
        'deployCompletionMarkerMissing',
    };
    return _text(key);
  }

  String deployServiceName(SelfHostedDeployServiceKind service) {
    final key = switch (service) {
      SelfHostedDeployServiceKind.bootstrap => 'deployServiceBootstrap',
      SelfHostedDeployServiceKind.relay => 'deployServiceRelay',
      SelfHostedDeployServiceKind.turn => 'deployServiceTurn',
    };
    return _text(key);
  }

  String deployReadiness(SelfHostedDeployReadinessEvent event) {
    final key = switch (event.kind) {
      SelfHostedDeployReadinessKind.readyAfterRetry =>
        'deployServiceReadyAfterRetry',
      SelfHostedDeployReadinessKind.notReadyYet => 'deployServiceNotReadyYet',
    };
    return _format(key, {
      'service': deployServiceName(event.service),
      'attempt': event.attempt,
      'error': event.error,
    });
  }

  String remoteCommandFailed(int exitCode) =>
      _format('remoteCommandFailed', {'exitCode': exitCode});
  String remoteCommandLastLines(String lines) =>
      _format('remoteCommandLastLines', {'lines': lines});
  ...
  String get relayNotConfigured => _text('relayNotConfigured');
  String get relayUnavailable => _text('relayUnavailable');
  ...
  String get saveMessage => _text('saveMessage');
  String get forward => _text('forward');
  ...
  String get noForwardTargets => _text('noForwardTargets');
  ...
  String get messageCopied => _text('messageCopied');
  String get savedToGallery => _text('savedToGallery');
  String saveMediaError(Object error) =>
      _format('saveMediaError', {'error': error});
