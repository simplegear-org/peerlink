...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final baseBubbleColor =
        message.incoming ? AppTheme.paper : AppTheme.accentSoft;
    ...
    final alignment =
        message.incoming ? Alignment.centerLeft : Alignment.centerRight;
    final statusColor = _statusColor(message.status);
    final showProgress = message.kind == MessageKind.file &&
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    widget.message.fileName ?? 'Голосовое сообщение',
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                  ...
                  const SizedBox(height: 4),
                  Text(
                    hasFile ? 'Голосовое сообщение' : 'Аудиофайл недоступен',
                    style: theme.textTheme.bodySmall?.copyWith(
                      color: AppTheme.muted,
                    ),
                  ),
            ...
            const SizedBox(width: 8),
            Text(
              _formatAudioDuration(_duration > Duration.zero ? _duration : _position),
              style: theme.textTheme.labelMedium?.copyWith(
                color: AppTheme.muted,
                fontWeight: FontWeight.w700,
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        Text(
          '${message.transferStatus ?? "Отправка"}${value > 0 ? " $percent%" : ""}',
          style: theme.textTheme.bodySmall?.copyWith(
            color: AppTheme.muted,
          ),
        ),
