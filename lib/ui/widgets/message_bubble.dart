...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final emojiPresentation = _EmojiPresentation.tryParse(message);
...
class _EmojiPresentation {
  final int emojiCount;

  const _EmojiPresentation._(this.emojiCount);

  static _EmojiPresentation? tryParse(Message message) {
    ...
    return _EmojiPresentation._(emojiCount);
  }
...
class _AnimatedEmojiText extends StatelessWidget {
  final String text;
  final int emojiCount;

  const _AnimatedEmojiText({required this.text, required this.emojiCount});
