...
import 'package:peerlink/features/chat/application/chat_direct_outbound_handler.dart';
...
class ChatOutboundService {
  ...
  ChatOutboundService({
    ...
    _mediaOutboundService = ChatMediaOutboundService(
      facade: facade,
    ...
    _directOutboundHandler = ChatDirectOutboundHandler(
      ...
      mediaOutboundService: _mediaOutboundService,
      directMediaCryptoService: _directMediaCryptoService,
    );
