...
enum CallRecoveryKind { ice, camera }
...
class CallState {
  ...
  final CallPhase? recoveryReturnPhase;
  ...
  bool get isRecovering => phase == CallPhase.recovering;
  bool get isBusy =>
      isIncoming || isOutgoing || isConnecting || isActive || isRecovering;
  ...
  CallState copyWith({
    ...
    bool clearRecoveryKind = false,
    bool clearRecoveryReturnPhase = false,
    ...
    return CallState(
      ...
      recoveryKind: clearRecoveryKind
          ? null
          : (recoveryKind ?? this.recoveryKind),
      recoveryAttempt: recoveryAttempt ?? this.recoveryAttempt,
      recoveryReturnPhase: clearRecoveryReturnPhase
          ? null
          : (recoveryReturnPhase ?? this.recoveryReturnPhase),
