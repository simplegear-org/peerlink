...
class NotificationService {
  ...
  Future<bool> init() async {
    ...
    debugPrint(
      'NotificationService init: permissionGranted=$_permissionGranted',
    );
  ...
  Future<void> showMessageNotification({
    ...
    try {
      ...
      if (!_initialized || !_permissionGranted) {
        debugPrint(
          'NotificationService: cannot show notification, permission denied',
        );
        return;
      }
      ...
      debugPrint(
        'NotificationService: showMessageNotification failed $e\n$stack',
      );
    }
  }
}
