...
class RelayBlobNotFoundException implements Exception {
  final String blobId;
  final String details;

  RelayBlobNotFoundException(this.blobId, {this.details = 'blob not found'});

  @override
  String toString() =>
      'RelayBlobNotFoundException(blobId=$blobId, details=$details)';
}

class RelayUnavailableException implements Exception {
  static const String notConfigured = 'no message relay servers configured';
  static const String unavailable = 'message relay servers unavailable';

  final String details;

  RelayUnavailableException({this.details = notConfigured});

  bool get isNotConfigured => details == notConfigured;

  bool get isUnavailable => details == unavailable;

  @override
  String toString() => 'RelayUnavailableException(details=$details)';
}
...
class RelayWriteReceipt {
  ...
  const RelayWriteReceipt({required this.serverUrls});
...
class RelayBlobDownload {
  ...
  factory RelayBlobDownload.notFound(String blobId) {
