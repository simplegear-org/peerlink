...
class FirebasePushCallbackRegistry {
  ...
  get onServersFromPush => ServerUpdateCallbackRegistry.onServersUpdate;
  static set onServersFromPush(
    Future<void> Function(PushServerUpdate update)? callback,
  ) => ServerUpdateCallbackRegistry.onServersUpdate = callback;
  ...
  static Future<void> waitForPendingServersApply({
    ...
    await ServerUpdateCallbackRegistry.waitForPendingServersApply(
      timeout: timeout,
