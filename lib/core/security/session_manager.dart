...
class SecurePeerIdentityStore implements PeerIdentityStore {
  ...
  @override
  Future<String?> read(String peerId) => _storage.read(key: '$_prefix$peerId');

  @override
  Future<void> write(String peerId, String value) {
    return _storage.write(key: '$_prefix$peerId', value: value);
  }
}
...
class SessionManager {
  ...
  }) : _peerIdentityStore = peerIdentityStore ?? const SecurePeerIdentityStore();
  ...
  Future<Uint8List> receiveHandshake(
    String peerId,
    Uint8List payload,
  ) async {
