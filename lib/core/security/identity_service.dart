...
class IdentityService {
  ...
  late PeerIdentityBundleV3 _identityBundleV3;
  ...
  Future<void> initialize({String? fcmToken}) async {
    ...
    _identityBundleV3 = await _buildIdentityBundleV3();
    if (fcmToken != null) {
      await updateMessagingEndpoint(fcmToken);
    }
  ...
  Map<String, dynamic> identityProfileJson() {
    ...
    return <String, dynamic>{
      ...
      'identityBundleV3': _identityBundleV3.toJson(),
  ...
  Future<PeerIdentityBundleV3> _buildIdentityBundleV3() async {
    final signingPublicKey = base64Encode(_signingPublicKey.bytes);
    final agreementPublicKey = base64Encode(_agreementPublicKey.bytes);
