...
class NodeFacadeMessagingDelegate {
  ...
  Future<Uint8List> encryptDirectBytes(String peerId, Uint8List plainBytes) {
    return _chat.encryptDirectBytes(peerId, plainBytes);
  }
  ...
  Future<Uint8List> decryptDirectBytes(
    ...
    return _chat.decryptDirectBytes(peerId, encryptedBytes);
  }
  ...
  Future<void> discardPendingPayload({
    ...
    return _chat.discardPendingPayload(
      targetKind: targetKind,
      targetId: targetId,
      messageId: messageId,
    );
