...
class MeshNode {
  ...
  Future<int> pollRelay({List<String>? relayServers}) async {
    return messaging.pollRelay(relayServers: relayServers);
  }
  ...
  Map<String, dynamic>? collectRelayMessageServerMetadata() {
    return _pushRuntimeMetadataBuilder.collectAvailableServers()?.toJson();
  }
