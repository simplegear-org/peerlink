...
class NodeFacade {
  ...
  Future<bool> trustPeerIdentityBundleV3(
    ...
    return _node.sessions.trustPeerIdentityBundleV3(
      bundle,
  ...
  Future<Uint8List> encryptDirectBytes(String peerId, Uint8List plainBytes) {
    return _messaging.encryptDirectBytes(peerId, plainBytes);
  }
  ...
  Future<Uint8List> decryptDirectBytes(
    ...
    return _messaging.decryptDirectBytes(peerId, encryptedBytes);
  }
