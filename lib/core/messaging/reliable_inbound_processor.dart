...
typedef ReliablePeerIdentityBundleHandler =
    Future<bool> Function(String peerId, Map<String, dynamic> bundle);
...
class ReliableInboundProcessor {
  ...
  _decrypt;
  final ReliablePeerIdentityBundleHandler _handlePeerIdentityBundle;
  ...
  ReliableInboundProcessor({
    ...
    decrypt,
    required ReliablePeerIdentityBundleHandler handlePeerIdentityBundle,
    ...
    required void Function(String message) log,
       ...
       _decrypt = decrypt,
       _handlePeerIdentityBundle = handlePeerIdentityBundle,
  ...
  Future<bool> handleReliableEnvelope({
    ...
    final identityBundle = decoded['senderIdentityBundleV3'];
    if (identityBundle is Map) {
      final accepted = await _handlePeerIdentityBundle(
        fromPeerId,
        Map<String, dynamic>.from(identityBundle),
      );
      _log(
        'recv:identity-bundle peer=$fromPeerId accepted=$accepted '
        'id=$id',
      );
    }
